...
function SuperAdminLoginForm() {
  ...
  return (
    <main className="fixed inset-0 z-[100] flex min-h-dvh w-full items-center justify-center overflow-y-auto bg-paper px-5 py-10">
      <section className="w-full max-w-md rounded-2xl border border-line bg-white/[0.045] p-6 shadow-2xl backdrop-blur-xl sm:p-8">
